...
public class IntakeRingUntilCapturedCmd extends Command {
    
    private StorageSubsystem storageSubsystem;
    private ShootingSubsystem shootingSubsystem;

    public IntakeRingUntilCapturedCmd(StorageSubsystem storageSubsystem, ShootingSubsystem shootingSubsystem) {
